...
export TEMPO_QUERY_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/tempo/tempo-query@sha256:8fa7bdf121c9f0413afd4d3156f7a30c652c9f335217a62b9d2813377f971635"
# Separate due to merge conflicts
