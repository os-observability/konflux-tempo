...
# separate due to merge conflicts
export TEMPO_OPA_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/tempo/tempo-opa@sha256:42922ef072231a818b5528a5fa3af1ab3ec3af9bf1546562dfc660d300963ae9"
# Separate due to merge conflicts
